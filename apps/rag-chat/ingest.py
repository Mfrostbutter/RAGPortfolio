#!/usr/bin/env python3
"""
RAG Portfolio Ingestion Pipeline
...
collections per the manifest routing (public_kb, private_kb).

Usage:
  python ingest.py --collection public_kb
  python ingest.py --collection private_kb
...
VALID_COLLECTIONS = {"public_kb", "private_kb"}
...
TOPIC_TAXONOMY = {
    ...
    "msp": ["msp", "managed service", "connectwise"],
    "leadership": ["leadership", "manager", "team", "mentor", "lead ", "leader", "director", "vp "],
    "career": ["career", "experience", "background", "job", "role", "position", "history"],
