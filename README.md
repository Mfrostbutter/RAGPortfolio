...
- [`apps/rag-chat/data/PROCESSING-PROMPTS.md`](apps/rag-chat/data/PROCESSING-PROMPTS.md) — ready-to-paste agent prompts for distilling each source type into ingest-ready markdown
